...
const ReadDiscreteInputsResponseBody = require('../dist/response/read-discrete-inputs.js')
  .default;
const ReadHoldingRegistersResponseBody = require('../dist/response/read-holding-registers.js')
  .default;
const ReadInputRegistersResponseBody = require('../dist/response/read-input-registers.js')
  .default;
const WriteSingleCoilResponseBody = require('../dist/response/write-single-coil.js')
  .default;
const WriteSingleRegisterResponseBody = require('../dist/response/write-single-register.js')
  .default;
const WriteMultipleCoilsResponseBody = require('../dist/response/write-multiple-coils.js')
  .default;
const WriteMultipleRegistersResponseBody = require('../dist/response/write-multiple-registers.js')
  .default;
...
describe('Modbus/TCP Server Response Handler Tests', function() {
  ...
  it('should handle a valid read discrete inputs request', function() {
    ...
    const discreteInputs = Buffer.from([0xff]);
  ...
  it('should handle a valid write multiple registers request', function() {
    const requestBuffer = Buffer.from([
      ...
      0x10, // function code
      0x00,
      0x01, // starting address
      0x00,
      0x02, // quantity of outputs
      0x04, // byte count
      0x00,
      0x0a, // outputs value
      0x01,
