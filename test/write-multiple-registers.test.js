...
const WriteMultipleRegistersRequest = require('../dist/request/write-multiple-registers.js')
  .default;
...
describe('WriteMultipleRegisters Tests.', function() {
  ...
  describe('WriteMultipleRegisters Request', function() {
    it('should create a buffer from a write multiple registers message', function() {
      const request = new WriteMultipleRegistersRequest(10, [
        0x0001,
        0x0002,
        0x1234,
        0x4321
    ...
    it('should create a message from a buffer', function() {
      ...
      assert.deepEqual(
        Buffer.from([0x00, 0x01, 0x00, 0x02, 0x12, 0x34, 0x43, 0x21]),
        message.valuesAsBuffer
      );
    });
