...
export default class ModbusServer extends EventEmitter {
  ...
  constructor(
    options: Partial<ModbusServerOptions> = DEFAULT_MODBUS_SERVER_OPTIONS
  ) {
    super();
  ...
  emit(
    event: 'preReadDiscreteInputs',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'postReadDiscreteInputs',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'readHoldingRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'preReadHoldingRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'postReadHoldingRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(event: 'readInputRegisters', request: any, cb: BufferCallback): boolean;
  emit(
    event: 'preReadInputRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'postReadInputRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  ...
  emit(
    event: 'preWriteSingleRegister',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'postWriteSingleRegister',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(event: 'writeMultipleCoils', request: any, cb: BufferCallback): boolean;
  emit(
    event: 'preWriteMultipleCoils',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'writeMultipleCoils',
    coils: Buffer,
    oldStatus: BooleanArray
  ): boolean;
  emit(
    event: 'postWriteMultipleCoils',
    coils: Buffer,
    newStatus: BooleanArray
  ): boolean;
  emit(
    event: 'postWriteMultipleCoils',
    request: any,
  ...
  emit(
    event: 'writeMultipleRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  emit(
    event: 'preWriteMultipleRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
  ...
  emit(
    event: 'postWriteMultipleRegisters',
    request: any,
    cb: BufferCallback
  ): boolean;
